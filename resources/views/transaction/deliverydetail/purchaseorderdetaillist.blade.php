                ...
                <table id="" class="table table-hover datatables">
                    ...
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-secondary">{{ $purchaseOrderDetail->purchaseOrder->total_delivery_per_item($purchaseOrderDetail->item_id) . '/'. ($purchaseOrderDetail->quantity + 0) }} {{ $purchaseOrderDetail->item->unit }}</span></td>
                        </tr>
                        @empty
