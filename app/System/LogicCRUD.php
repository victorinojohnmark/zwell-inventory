...
class LogicCRUD
{
    ...
    public static function saveRecord($model, $namespace, $values, $id = null, $event = null, $successview = null) 
    {
        ...
        //update rules not applicable for update: unique fields
        // if (!is_null($id) && in_array(substr($record_type, strrpos($record_type, '\\') + 1), ['Company','Supplier','Location'])) { 
        
        //     //unset($record->validationrules['company_name'])
        // }
